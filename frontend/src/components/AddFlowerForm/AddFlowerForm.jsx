...
function AddFlowerForm (props) {
  ...
  function changeNotificationText() {
    if (form.notification === true && notificationText === 'Никогда!') {console.log('давайте'); setNotificationText('Давайте!');}
    if (form.notification === true && notificationText === 'Давайте!') {console.log('Никогда!'); setNotificationText('Никогда!');};
  }
    ...
    <>
      ...
      <form 
        ...
        <div className="editFlowerForm__buttonBlock">
          ...
          <label htmlFor="notification">{notificationText}</label>
        </div>
