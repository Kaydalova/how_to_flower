  ...
  return(
    <div className="profile">
      ...
      <div className="profile__title-block">
        {userDataRequestRes && userDataRequestRes !== {} && userDataRequestRes.first_name !== null && userDataRequestRes.first_name !== undefined &&
          <p className="profile__mainTitle">
            С возвращением, {userDataRequestRes.first_name}!
          </p>
        }
        <img 
          src={pensil} 
          alt="Иконка исправления" 
      ...
      <Modal
        ...
        children={
          <AddFlowerForm 
            ...
            handleEditUserTlg={handleEditUserTlg}
